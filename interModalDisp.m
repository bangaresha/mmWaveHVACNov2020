function [channel, att, totPowerS, theta, meanDelay, rmsDelay, pn_dB] = interModalDisp(freq,fc_TE,fc_TM,c,m_TE,n_TE,m_TM,n_TM,k,WGlen,radius,Zo,R,eta,l,coWnTE,coWnTM)
...
% rmsDelay = 4*sqrt(meanDelaySq - meanDelay*meanDelay)/1E2;
% 
% denSum = sum(pn);
...
% end
% rmsDelay = (abs(sqrt(temp2/denSum)))*5.5E-3;
